  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="VIMAK navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="index.php">VIMAK INFOTECH LABS<span>.</span></a>
					...
					<div class="row justify-content-between">
						...
						<div class="col-lg-7">
							<div class="hero-img-wrap">
								<!-- <img src="images/vimak-infotech-labs-logo.png" style="height: 500px; width: 600px; " class="img-fluid"> -->
							</div>
						</div>
					</div>
				</div>
		...
		<div class="untree_co-section">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="images/user.svg" class="img-fluid mb-5">
						<h3 clas><a href="#"><span class="">Admin@</span> VIMAK</a></h3>
            <span class="d-block position mb-4">CEO, Founder, VIMAK Infotech Labs.</span>
            <p>"Exceeding our clients' expectations is our top priority and we guarantee total satisfaction with our professional managed services."</p>
            <p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
					...
					<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="images/user.svg" class="img-fluid mb-5">
						<h3 clas><a href="#"><span class="">Support@</span> VIMAK</a></h3>
            <span class="d-block position mb-4">CEO, Founder, VIMAK Infotech Labs.</span>
            <p>"Exceeding our clients' expectations is our top priority and we guarantee total satisfaction with our professional managed services."</p>
            <p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
					</div> 
					...
					<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="images/user.svg" class="img-fluid mb-5">
						<h3 clas><a href="#"><span class="">Customer_Care@</span> VIMAK</a></h3>
            <span class="d-block position mb-4">CEO, Founder, VIMAK Infotech Labs.</span>
            <p>"Exceeding our clients' expectations is our top priority and we guarantee total satisfaction with our professional managed services."</p>
            <p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
					</div> 
					...
					<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="images/user.svg" class="img-fluid mb-5">
						<h3 clas><a href="#"><span class="">Developers@</span> VIMAK</a></h3>
            <span class="d-block position mb-4">CEO, Founder, VIMAK Infotech Labs.</span>
            <p>"Exceeding our clients' expectations is our top priority and we guarantee total satisfaction with our professional managed services."</p>
            <p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
					</div> 
